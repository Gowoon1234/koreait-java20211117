...
/*
 * 오버로딩
 * 메소드 이름은 같지만 매게변수가 다르면 다른 메소드로 취급한다.
 */
...
public class OverloadingEx {
	 ...
	 * 문자열의 형변환
	 * 1. 문자열 -> int, dauble
	 * Interger.parseInt("1000000");  문자열을 정수로 변환
	 * Doble.parseDouble("1000000.1");  문자열을 실수로 변환
	 * Long, Boolean
	 * 
	 * 2. int, double ->  문자열
	 * Interger.toString("1000000");  정수를 문자열로 변환
	 * Doble.toString("1000000.1");  실수를 문자열로 변환
	 */
